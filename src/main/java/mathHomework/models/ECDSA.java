...
public class ECDSA {
    ...
    public static EncryptionKey ecdsa(String privateKey){
        CurvePoint generationPoint= new CurvePoint(ECDSAConstants.Gx,ECDSAConstants.Gy);

        return eccMultiply(generationPoint, privateKey);
...
//        return addOutput(registerValues);s
    }

    private static CurvePoint eccMultiply(CurvePoint generationPoint, String privateKey) {
...
//        return (Q)
    ...
    private static CurvePoint eccDouble(CurvePoint curvePoint) {
...
//        return (x,y)
    ...
    private static CurvePoint eccAdd(CurvePoint curvePoint) {
...
//        return (x,y)
    ...
    private static CurvePoint modinv(CurvePoint curvePoint) {
//        lm, hm = 1,0
//        low, high = a%n,n
//        while low > 1:
//        ratio = high/low
