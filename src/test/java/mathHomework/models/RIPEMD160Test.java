...
class RIPEMD160Test {
    ...
    public void testProcessRound(){
        ...
        ripemd160.messageBlocks = new String[]{"73d6c4f6", "fe2f916f", "14fb65be", "a1c2aa97", "8837d011", "d7b5393f", "9fd3a02e", "68d36e21", "00000080", "00000000", "00000000", "00000000", "00000000", "00000000", "00000100", "00000000"};
        Map<String, BigInteger>  result = ripemd160.processRound(currentValues,0,0);
